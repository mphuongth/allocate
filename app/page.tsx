  ...
  return (
    <>
      ...
      <div style={{ fontFamily: "'Be Vietnam Pro', -apple-system, sans-serif", overflowX: 'hidden', background: CANVAS }}>
        ...
        {/* ── Nav ───────────────────────────────────────────────────────────── */}
        <nav style={{ position: 'sticky', top: 0, zIndex: 200, background: NAVY, borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
          <div style={{ maxWidth: 1120, margin: '0 auto', padding: '0 48px', height: 58, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 9, textDecoration: 'none' }}>
              <CairnLogo width={26} height={22} />
              <span style={{ fontSize: 19, fontWeight: 700, color: '#fff', letterSpacing: '-0.03em' }}>Cairn</span>
            </Link>
        ...
        {/* ── Hero ──────────────────────────────────────────────────────────── */}
        <section style={{ background: NAVY, backgroundImage: 'radial-gradient(rgba(255,255,255,0.035) 1px, transparent 1px)', backgroundSize: '28px 28px', paddingTop: 88, overflow: 'hidden' }}>
          <div style={{ maxWidth: 1120, margin: '0 auto', padding: '0 48px', display: 'grid', gridTemplateColumns: '1fr 1fr', alignItems: 'flex-end', gap: 56 }}>
            {/* Copy */}
            <div style={{ paddingBottom: 80 }}>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, fontSize: 11, fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.45)', marginBottom: 22 }}>
                <span style={{ width: 6, height: 6, borderRadius: '50%', background: POS, display: 'block', flexShrink: 0 }}/>
                {t('eyebrow')}
              </div>
              <h1 style={{ margin: '0 0 18px', fontSize: 58, fontWeight: 700, color: '#fff', letterSpacing: '-0.04em', lineHeight: 1.06 }}>
                {t('heroH1')}
              </h1>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'flex-end' }}>
              <div style={{ width: 540, flexShrink: 0, background: '#fff', borderRadius: '12px 12px 0 0', boxShadow: '0 -8px 64px rgba(0,0,0,0.45), 0 0 0 1px rgba(255,255,255,0.08)', overflow: 'hidden' }}>
                {/* Browser chrome */}
                <div style={{ background: '#edeae2', padding: '10px 14px', display: 'flex', alignItems: 'center', gap: 10, borderBottom: '1px solid #e0dcd2' }}>
                  ...
                  <div style={{ flex: 1, textAlign: 'center', fontFamily: 'ui-monospace, monospace', fontSize: 10.5, color: '#78716c', background: '#e0dcd2', borderRadius: 5, padding: '3px 10px' }}>
                    cairn.app/dashboard
                  </div>
                </div>
                {/* App layout */}
                <div style={{ display: 'flex', height: 400, overflow: 'hidden' }}>
                  {/* Sidebar */}
                  <div style={{ width: 52, background: NAVY, flexShrink: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '14px 0', gap: 4 }}>
                    <div style={{ marginBottom: 12 }}>
                      <CairnLogo width={20} height={17} />
                    </div>
                    <div style={{ width: 34, height: 34, borderRadius: 9, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(255,255,255,0.15)' }}>
                    ...
                    <div style={{ width: 34, height: 34, borderRadius: 9, display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: 'auto' }}>
                  ...
                  {/* Main content */}
                  <div style={{ flex: 1, background: '#faf8f4', padding: '16px 18px', overflow: 'hidden', display: 'flex', flexDirection: 'column', gap: 0 }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14, borderBottom: '1px solid #e9e5dc', paddingBottom: 12 }}>
                      <div>
                        ...
                        <div style={{ fontSize: 15, fontWeight: 700, color: INK, letterSpacing: '-0.025em' }}>Hi, Minh</div>
                      </div>
                      <div style={{ display: 'flex', gap: 5 }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginBottom: 14 }}>
                      <div style={{ background: '#fff', border: `1px solid #e9e5dc`, borderRadius: 10, padding: '9px 12px' }}>
                        ...
                        <div style={{ fontSize: 17, fontWeight: 700, color: INK, letterSpacing: '-0.03em', fontVariantNumeric: 'tabular-nums' }}>487.5M ₫</div>
                      </div>
                      <div style={{ background: '#fff', border: `1px solid #e9e5dc`, borderRadius: 10, padding: '9px 12px' }}>
                        ...
                        <div style={{ fontSize: 17, fontWeight: 700, color: POS, letterSpacing: '-0.03em', fontVariantNumeric: 'tabular-nums' }}>+41.3M ₫</div>
                      </div>
                    </div>
        ...
        <section id="features" style={{ padding: '96px 0', background: CANVAS }}>
          <div style={{ maxWidth: 1120, margin: '0 auto', padding: '0 48px' }}>
            <div className="reveal" style={{ textAlign: 'center', marginBottom: 52 }}>
              ...
              <h2 style={{ fontSize: 40, fontWeight: 700, color: INK, letterSpacing: '-0.038em', lineHeight: 1.1, margin: '0 0 14px' }}>{t('featuresH2')}</h2>
              <p style={{ fontSize: 16, color: MUTED, lineHeight: 1.65, maxWidth: 500, margin: '0 auto' }}>{t('featuresLead')}</p>
            </div>
          </div>
          <div style={{ maxWidth: 1120, margin: '0 auto', padding: '0 48px', display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 18 }}>
            {features.map((f, i) => (
              <div key={i} className={`reveal reveal-delay-${i + 1}`}
                ...
                <h3 style={{ fontSize: 15, fontWeight: 700, color: INK, letterSpacing: '-0.02em', margin: '0 0 7px' }}>{f.title}</h3>
                <p style={{ fontSize: 13.5, color: MUTED, lineHeight: 1.6, margin: 0 }}>{f.body}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        {/* ── How it works ─────────────────────────────────────────────────────── */}
        <section id="how" style={{ padding: '96px 0', background: '#fff', borderTop: `1px solid ${LINE}`, borderBottom: `1px solid ${LINE}` }}>
          <div style={{ maxWidth: 1120, margin: '0 auto', padding: '0 48px' }}>
            <div className="reveal" style={{ textAlign: 'center', marginBottom: 52 }}>
              ...
              <h2 style={{ fontSize: 40, fontWeight: 700, color: INK, letterSpacing: '-0.038em', lineHeight: 1.1, margin: '0 0 14px' }}>{t('howH2')}</h2>
              <p style={{ fontSize: 16, color: MUTED, lineHeight: 1.65, maxWidth: 500, margin: '0 auto' }}>{t('howLead')}</p>
            </div>
          </div>
          <div style={{ maxWidth: 1120, margin: '0 auto', padding: '0 48px', display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)' }}>
            {steps.map((s, i) => (
              <div key={i} className={`reveal reveal-delay-${i + 1}`}
                style={{ padding: '0 48px', borderRight: i < 2 ? `1px solid ${LINE}` : 'none', paddingLeft: i === 0 ? 0 : undefined }}>
                <div style={{ fontSize: 52, fontWeight: 700, letterSpacing: '-0.05em', color: '#d8d3c5', lineHeight: 1, marginBottom: 18 }}>{s.num}</div>
                <h3 style={{ fontSize: 17, fontWeight: 700, color: INK, letterSpacing: '-0.02em', margin: '0 0 9px' }}>{s.title}</h3>
        ...
        <section id="plan" style={{ padding: '96px 0', background: CANVAS, borderBottom: `1px solid ${LINE}` }}>
          <div style={{ maxWidth: 1120, margin: '0 auto', padding: '0 48px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'center' }}>
            {/* Copy */}
            <div className="reveal" style={{ maxWidth: 440 }}>
              ...
              <h2 style={{ fontSize: 40, fontWeight: 700, color: INK, letterSpacing: '-0.038em', lineHeight: 1.1, margin: '0 0 14px', textAlign: 'left' }}>{t('spotlightH2')}</h2>
        ...
        {/* ── CTA ─────────────────────────────────────────────────────────────── */}
        <section style={{ background: NAVY, padding: '100px 0', backgroundImage: 'radial-gradient(rgba(255,255,255,0.025) 1px, transparent 1px)', backgroundSize: '28px 28px' }}>
          <div style={{ maxWidth: 600, margin: '0 auto', padding: '0 48px', textAlign: 'center' }}>
            <div className="reveal" style={{ display: 'flex', justifyContent: 'center', marginBottom: 28 }}>
              <CairnLogo width={58} height={49} />
            </div>
            <h2 className="reveal" style={{ fontSize: 44, fontWeight: 700, color: '#fff', letterSpacing: '-0.04em', lineHeight: 1.1, margin: '0 0 16px' }}>{t('ctaH2')}</h2>
            <p className="reveal reveal-delay-1" style={{ fontSize: 16, color: 'rgba(255,255,255,0.55)', lineHeight: 1.65, margin: '0 0 38px' }}>{t('ctaSub')}</p>
            <div className="reveal reveal-delay-2" style={{ display: 'flex', gap: 10, justifyContent: 'center' }}>
              <Link href="/auth/signup"
                style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: '#fff', color: NAVY, fontSize: 13.5, fontWeight: 600, padding: '9px 20px', borderRadius: 10, border: 'none', textDecoration: 'none', whiteSpace: 'nowrap' }}
                className="hover:opacity-90 transition-opacity duration-150">
                {t('ctaCta1')}
        ...
        {/* ── Footer ──────────────────────────────────────────────────────────── */}
        <footer style={{ background: '#081b30', padding: '28px 0', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
          <div style={{ maxWidth: 1120, margin: '0 auto', padding: '0 48px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
