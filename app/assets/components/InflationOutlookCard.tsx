...
// above it stays nominal money over the nominal target, because that ratio is
...
//
// Both directions are shown deliberately. "The target grows" tells the user how
// much more to put in; "idle savings shrink" tells them what standing still
// costs. They are one division apart — see goalInflationOutlook — but they are
// not the same question, and users ask both.
...
export default function InflationOutlookCard({
  ...
  const rate = fmtRate(outlook.ratePct)
  ...
  return (
    ...
    >
      ...
      <div data-testid="inflation-savings-today" style={{ fontSize: 12, color: 'var(--c-muted)', marginTop: 10, paddingTop: 10, borderTop: '1px solid var(--c-line)' }}>
        {isVi
