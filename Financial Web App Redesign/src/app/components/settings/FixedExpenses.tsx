          ...
          <table className="w-full">
            <thead>
              <tr className="border-b text-left">
                <th className="pb-3 text-xs font-medium text-gray-500 uppercase">Name</th>
                <th className="pb-3 text-xs font-medium text-gray-500 uppercase">Category</th>
                <th className="pb-3 text-xs font-medium text-gray-500 uppercase text-right">Amount / Month</th>
                <th className="pb-3 text-xs font-medium text-gray-500 uppercase">Date Created</th>
            ...
            <tbody className="divide-y">
              {expenses
                ...
                <tr key={expense.id} className="hover:bg-gray-50">
                  <td className="py-4 font-medium text-gray-900">{expense.name}</td>
                  <td className="py-4">
                  ...
                  <td className="py-4 text-sm text-gray-600">{expense.dateCreated}</td>
                  <td className="py-4">
