          ...
          <table className="w-full">
            <thead>
              <tr className="border-b text-left">
                ...
                <th className="pb-3 text-xs font-medium text-gray-500 uppercase">Fund / Asset</th>
                <th className="pb-3 text-xs font-medium text-gray-500 uppercase text-right">Amount</th>
                <th className="pb-3 text-xs font-medium text-gray-500 uppercase text-right">Transaction</th>
                <th className="pb-3 text-xs font-medium text-gray-500 uppercase text-right">Interest Rate</th>
                <th className="pb-3 text-xs font-medium text-gray-500 uppercase text-right">Expiry</th>
                <th className="pb-3 text-xs font-medium text-gray-500 uppercase">Goal</th>
            ...
            <tbody className="divide-y">
              {transactions.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage).map((transaction) => (
                <tr key={transaction.id} className="hover:bg-gray-50">
                  ...
                  <td className="py-3">
                    <Badge variant={transaction.goal === 'Unassigned' ? 'secondary' : 'default'}>
                      {transaction.goal}
                    </Badge>
                  </td>
